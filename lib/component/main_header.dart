    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          const SizedBox(width: 10),
          GestureDetector( // GestureDetector to detect taps on the cart button
            onTap: () {
              FocusScope.of(context).requestFocus(FocusNode());
              Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => ProductCart()), // Replace CartPage with your cart page widget
              );
            },
            child: badges.Badge (
